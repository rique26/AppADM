...
import com.example.appadm.databinding.ActivityTelaCadastroOficialBinding
...
class TelaCadastroOficial() : AppCompatActivity() {
    private lateinit var binding: ActivityTelaCadastroOficialBinding
    var mensagens = arrayOf("Preencha todos os campos", "Cadastro realizado com sucesso")
    var usuarioID: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        this.enableEdgeToEdge()
        this.binding = ActivityTelaCadastroOficialBinding.inflate(layoutInflater)
